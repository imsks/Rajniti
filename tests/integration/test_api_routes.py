...
pytestmark = pytest.mark.skip(reason="Integration tests require database setup. Run unit tests instead.")
...
class TestElectionRoutes:
    ...
    def test_get_elections(self, client, mock_data_service):
        ...
        mock_data_service.get_elections.return_value = [
            {'id': 'lok-sabha-2024', 'name': 'Lok Sabha 2024', 'type': 'LOK_SABHA', 'year': 2024}
        ]
    ...
    def test_get_election_by_id(self, client, mock_data_service):
        ...
        mock_election = Mock()
        mock_election.copy = Mock(return_value={
            'id': 'lok-sabha-2024',
            'name': 'Lok Sabha 2024',
            'type': 'LOK_SABHA',
            'year': 2024
