...
export default function PreambleSection() {
  return (
    <section className="py-24 bg-linear-to-b from-orange-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-14">
          ...
          <Text
            variant="h1"
            weight="bold"
            className="text-[#0F1F3D] dark:text-white mb-2 text-3xl sm:text-4xl"
          >
            The <span className="text-orange-600 italic">Constitution</span> of
            India
          </Text>
            ...
            <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
              <div>
                <div className="mb-6">
                  ...
                  <Text
                    variant="body"
                    className="text-gray-600 dark:text-gray-400 italic mt-3"
                  >
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400 italic mt-6">
                  ...
                  1949, we do hereby adopt, enact and give to ourselves this
                  Constitution.
                </div>
              </div>
                ...
                <div className="grid gap-4">
                  <div className="rounded-xl border border-orange-100 dark:border-orange-800/40 bg-orange-50/70 dark:bg-orange-900/20 p-5">
                    <Text
                      variant="h4"
                      weight="bold"
                      className="text-orange-900 dark:text-orange-300 mb-1 text-lg"
                    >
                      JUSTICE
                    </Text>
                    <Text
                  ...
                  <div className="rounded-xl border border-blue-100 dark:border-blue-800/40 bg-blue-50/70 dark:bg-blue-900/20 p-5">
                    <Text
                      variant="h4"
                      weight="bold"
                      className="text-blue-900 dark:text-blue-300 mb-1 text-lg"
                    >
                      LIBERTY
                    </Text>
                    <Text
                  ...
                  <div className="rounded-xl border border-purple-100 dark:border-purple-800/40 bg-purple-50/70 dark:bg-purple-900/20 p-5">
                    <Text
                      variant="h4"
                      weight="bold"
                      className="text-purple-900 dark:text-purple-300 mb-1 text-lg"
                    >
                      EQUALITY
                    </Text>
                    <Text
                  ...
                  <div className="rounded-xl border border-green-100 dark:border-green-800/40 bg-green-50/70 dark:bg-green-900/20 p-5">
                    <Text
                      variant="h4"
                      weight="bold"
                      className="text-green-900 dark:text-green-300 mb-1 text-lg"
                    >
                      FRATERNITY
                    </Text>
                    <Text
