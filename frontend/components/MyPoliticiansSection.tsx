...
export default function MyPoliticiansSection({
  ...
  const { myMP, myMLA, setMyMP, setMyMLA } = useMyPoliticians(
    allPoliticians,
    userId,
  );
  ...
  return (
    <m.section
      ...
      className="mb-10 rounded-2xl bg-linear-to-br from-amber-50/80 via-orange-50/40 to-amber-50/60 dark:from-gray-800/80 dark:via-gray-800/40 dark:to-gray-800/60 border border-amber-200/60 dark:border-gray-700 shadow-sm overflow-hidden"
    >
      <div className="p-6 sm:p-8">
        <div className="mb-4">
          ...
          >
            {isEmpty ? "Add Your Local Politicians" : "Your Politicians"}
          </Text>
                    ...
                    <li key={`${p.id}-${p.type}`}>
                      ...
                      >
                        {p.photo ? (
                          ...
                          <div className="w-10 h-10 rounded-full bg-linear-to-br from-orange-100 to-orange-200 dark:from-orange-900/40 dark:to-orange-800/40 flex items-center justify-center border border-orange-200 dark:border-orange-700">
        ...
        <div className="border-t border-amber-200/60 dark:border-gray-700 pt-4">
          ...
          {!showPincodeFallback ? (
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              />
              <Button variant="primary" size="sm" onClick={handlePincodeSubmit}>
                Search on Google
              </Button>
              <button
                type="button"
