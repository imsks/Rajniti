...
class TestUserModel:
    ...
    def test_user_repr(self, mock_user):
        ...
        repr_str = repr(mock_user)
        # Mock has different repr, but we test the actual model in integration tests
    ...
    def test_user_has_required_fields(self, mock_user):
        ...
        required_fields = ['id', 'email', 'name', 'username', 'profile_picture',
                          'state', 'city', 'pincode', 'age_group', 
                          'political_ideology', 'onboarding_completed']
...
class TestUserValidation:
    ...
    def test_valid_political_ideologies(self):
        ...
        valid_ideologies = ['Rightist', 'Leftist', 'Communist', 'Centrist', 'Libertarian', 'Neutral']
