...
# Per-candidate HTTP timeout. Gemini + long structured prompts often need >15s;
# override with FREE_TIER_LLM_TIMEOUT_SECS if needed.
_REQUEST_TIMEOUT_SECS = _float_env("FREE_TIER_LLM_TIMEOUT_SECS", 120.0)
